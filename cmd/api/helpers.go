...
func (app *application) writeJSON(w http.ResponseWriter, status int, data envelope, headers http.Header) error {
	// Encode the data too JSON, returning the error if there was one.
	// Use the json.MarshalIndent()n function so that whitesapce is added to the encoded
	...
	// through the headers map and add each header to the http.ResponseWriter header map.
	...
	// Add thee "content-Type: application/json" header, then write the status code and 
	// JSON response.
...
func (app *application) readJSON(w http.ResponseWriter, r *http.Request, dst interface{}) error {
	...
	if err != nil {
		...
		switch {
			...
			// In some circunstances Decode() may also return an io.ErrUnexpectedEOF error
